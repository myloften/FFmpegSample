...
void continueAfterSETUP(RTSPClient *rtspClient, int resultCode, char *resultString) {
    do {
        ...
        ((DummySink *)scs.subsession->sink)->_decodeData_cb = ((ourRTSPClient *) rtspClient)->_decodeData_cb;
...
int CRTSPSession::openURL(UsageEnvironment &env, char const *progName, char const *rtspURL,
    ...
    ((ourRTSPClient *)m_rtspClient)->_decodeData_cb = _decodeData_cb;
